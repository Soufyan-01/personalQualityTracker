package com.example.personalQualityTracker.security.presentation.filter;

//import com.fasterxml.jackson.databind.ObjectMapper;
//import com.example.dreamteam.security.data.User;
//import com.example.dreamteam.security.presentation.dto.Login;
...
import com.example.personalQualityTracker.security.presentation.dto.Login;
import com.fasterxml.jackson.databind.ObjectMapper;
import io.jsonwebtoken.Jwts;
import io.jsonwebtoken.SignatureAlgorithm;
import io.jsonwebtoken.security.Keys;
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response,
        ...
        try {
            String token = Jwts.builder()
                    ...
                    .setIssuer("dreamteam-api")
                    .setAudience("dreamteam")
            ...
            response.addHeader("Role", String.valueOf(roles));


            PrintWriter printWriter = response.getWriter();
            printWriter.println(token + "," + roles);
